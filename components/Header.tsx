  ...
  return (
    <header className="border-b border-[#1A324F] bg-[#1E3A5F]">
      <div className="mx-auto flex h-14 w-full max-w-5xl items-center justify-between px-6">
        <Link href="/dashboard" className="text-[18px] font-semibold text-white">
          LessonBase
        </Link>
        ...
        <div>
          <button
            ...
            className="rounded border border-white/30 px-3 py-1.5 text-sm text-white transition hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-60"
          >
